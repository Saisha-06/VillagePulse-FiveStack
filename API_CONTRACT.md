  ...
  "reports" [
    {
      ...
      "createdAt" "2025-08-01T100000Z",
      "updatedAt" "2025-08-05T120000Z",
"supportersCount" 3,
      "status" "Pending",
...
**Request Parameters (Query)**
`/api/reports/alerts?latitude=15.2993&longitude=74.1240&radius=3&since=2025-08-09T100000Z`
  ...
  "reports" [
    {
      ...
      "status" "In Progress",
      "createdAt" "2025-07-01T100000Z",
      "updatedAt" "2025-07-05T120000Z",
...
```json
{
  ...
  "resolutionNote" "Tree cleared by team at 430 PM",
  ...
  "feedback" [
    {
      ...
      "submittedAt" "2025-08-09T153000Z"
    },
    {
      "userId""u1230",
      "rating" 5,
      ...
      "submittedAt" "2025-08-09T160000Z"
    }
  ]
}
```
